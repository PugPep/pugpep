  ...
  return (
    <aside style={sidebar}>
      <div style={sidebarHeader}>
        ...
        <span style={countBadge}>{products.length}</span>
      </div>
        ...
        {[
          ...
          <button
            ...
            style={{
              ...statusFilterButton,
              borderColor:
                statusFilter === value ? "#00ff99" : "rgba(255,255,255,.13)",
              color: statusFilter === value ? "#00ff99" : "#aeb1b7",
              background:
                statusFilter === value
                  ? "rgba(0,255,153,.07)"
          ...
          products.map((product) => {
            ...
            return (
              <button
                key={product.id}
                type="button"
                onClick={() => void selectProduct(product.slug)}
                style={{
                  ...productListItem,
              ...
              >
                ...
                <span
                  style={{
                    ...productCategory,
                    color: product.is_active ? "#8f8f98" : "#ffcc00",
                  }}
                >
                  {!product.is_active
                    ? "HIDDEN"
