...
import AddProductPanel from "../../../components/admin/inventory/AddProductPanel";
...
import ProductDetailsPanel from "../../../components/admin/inventory/ProductDetailsPanel";
        ...
        <div className="inventory-layout" style={workspace}>
          ...
          <section style={contentStack}>
            ...
            {admin.showAddProduct && (
              <AddProductPanel admin={admin} />
            )}

            <DosageAccordion admin={admin} />
            <ProductDetailsPanel admin={admin} />
          </section>
        </div>
