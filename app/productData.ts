...
export const products: Product[] = [
  ...
  },
  {
    ...
    options: [
      { dosage: "10mg", price: 50, status: "in stock", purchaseType: "single" },
      { dosage: "20mg", price: 80, status: "in stock", purchaseType: "single" },
      { dosage: "30mg", price: 100, status: "in stock", purchaseType: "single" },    
      { dosage: "40mg", price: 115, status: "in stock", purchaseType: "single" },
      { dosage: "60mg", price: 185, status: "in stock", purchaseType: "single" },
    ],
  },
  ...
  },
  {
    ...
    options: [
      { dosage: "10mg", price: 60, status: "in stock", purchaseType: "single" },
    ],
  },
  {
    name: "KLOW",
    ...
    options: [
      { dosage: "80mg", price: 70, status: "in stock", purchaseType: "single" },
    ],
  },
  {
    name: "Semax",
